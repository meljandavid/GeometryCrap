...
bool Tilemap::load(const std::string& tileset, sf::Vector2u _tileSize, const std::vector<std::vector<int>>& tiles) {
    height = tiles.size();
...
void Tilemap::updateTile(sf::Vector2u pos, int tileNumber) {
    int tu = tileNumber % textureWidth;
    int tv = tileNumber / textureWidth;
